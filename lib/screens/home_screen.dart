    ...
    return Scaffold(
      ...
      floatingActionButton: Container(
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: PetBuddyApp.trustGreen.withAlpha(80),
              blurRadius: 20,
  ...
  Widget _navItem(
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: isActive
              ? PetBuddyApp.primaryBlue.withAlpha(20)
              : Colors.transparent,
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                gradient: LinearGradient(
                  colors: [PetBuddyApp.primaryBlue, Color(0xFF1D4ED8)],
  ...
  Widget _trustStatusCard(UserModel? user) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: PetBuddyApp.borderColor.withAlpha(120)),
        boxShadow: [
          BoxShadow(
      ...
      child: Row(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: PetBuddyApp.trustGreen.withAlpha(25),
              shape: BoxShape.circle,
            ),
            child: Icon(
