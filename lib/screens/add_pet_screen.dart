...
class _AddPetScreenState extends State<AddPetScreen> {
          ...
          Container(
            ...
            decoration: const BoxDecoration(
              gradient: LinearGradient(
                colors: [PetBuddyApp.trustGreen, Color(0xFF059669)],
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                gradient: LinearGradient(
                                  colors: [
                                    PetBuddyApp.trustGreen.withAlpha(77),
                                    PetBuddyApp.primaryBlue.withAlpha(51),
                                  ],
                                ),
                              ),
                              child: Padding(
                                ...
                                child: CircleAvatar(
                                  radius: 50,
                                  backgroundColor: PetBuddyApp.borderColor,
                            ...
                            Positioned(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  boxShadow: [
                                    BoxShadow(
                                      color: PetBuddyApp.trustGreen.withAlpha(
                                        77,
                                      ),
                                      blurRadius: 8,
  ...
  Widget _buildTextField({
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        filled: true,
        fillColor: PetBuddyApp.surfaceLight,
      ),
    );
  }
  ...
  Widget _buildDropdown<T extends Enum>({
    ...
    return DropdownButtonFormField<T>(
      ...
      style: GoogleFonts.poppins(fontSize: 14, color: PetBuddyApp.textPrimary),
      items: items
          .map(
            (item) =>
